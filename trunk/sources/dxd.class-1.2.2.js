...
var DxD = new Class({
    ...
    createDrop: function ($objDrop) {
        ...
        $objDrop.bound = {
            enterDrop: function($objDrag) {this.enterDrop($objDrag, $objDrop)}.bind(this),
            leaveDrop: function($objDrag) {this.leaveDrop($objDrag, $objDrop)}.bind(this)
        };
	...
	createDrag: function ($objDrag, $options) {
		...
		var params = Array.link([$objDrag.node, this.options.drag], {'options': Object.type, 'element': $defined});
		...
		$objDrag.value = {'now': {}, 'umbral': {}};

		$objDrag.bound = {
            dragEnter: function($event){this.dragEnter($objDrag, $event)}.bind(this),
            dragLeave: function($event){this.dragLeave($objDrag, $event)}.bind(this),
